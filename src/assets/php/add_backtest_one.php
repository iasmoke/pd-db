...
//     );
//     while ($stmt->fetch()) {
//         $user_status_research = $user_status_research;
//     }
// }

    $sql = "UPDATE users_settings SET user_status_research=1 WHERE user_id=?";
    if ($stmt = $db_connect->prepare($sql)) {
        $stmt->bind_param("i", $user_id);
        $stmt->execute();
    }
    ...
    $sql = "INSERT INTO backtests (user_id, settings, description, select_type_oos,backtest_status,select_type_graphs) VALUES (?,?,'main',0,1,0)";
    if ($stmt = $db_connect->prepare($sql)) {
    ...
    $sql = "SELECT backtest_id FROM backtests WHERE user_id=? ORDER BY backtest_id DESC LIMIT 1";
    if ($stmt = $db_connect->prepare($sql)) {
        $stmt->bind_param("i", $user_id);
        $stmt->execute();
        $stmt->bind_result(
        ...
        while ($stmt->fetch()) {
            $backtest_id_py[] = $backtest_id;
        }
    }

    $err = "good";

    echo (json_encode(array('err' => $err,'backtest_id_py' => $backtest_id_py )));


// $sql = "UPDATE markets SET select_type=0 WHERE user_id=3";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }

// $sql = "UPDATE targets SET select_type=0 WHERE user_id=3";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }

// $sql="DELETE FROM features_set WHERE user_id=3";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }

// $sql = "UPDATE trading_settings SET parameter_value='0000-00-00' WHERE user_id=3 AND parameter_name='start_date'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
// $sql = "UPDATE trading_settings SET parameter_value='0000-00-00' WHERE user_id=3 AND parameter_name='end_date'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
// $sql = "UPDATE trading_settings SET parameter_value=3 WHERE user_id=3 AND parameter_name='periods_number'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
// $sql = "UPDATE trading_settings SET parameter_value='true' WHERE user_id=3 AND parameter_name='reversed_logic'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
// $sql = "UPDATE trading_settings SET parameter_value='true' WHERE user_id=3 AND parameter_name='straight_logic'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
// $sql = "UPDATE trading_settings SET parameter_value=30 WHERE user_id=3 AND parameter_name='min_trade_quantity'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
// $sql = "UPDATE trading_settings SET parameter_value=100000 WHERE user_id=3 AND parameter_name='start_deposit'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
// $sql = "UPDATE trading_settings SET parameter_value=1.8 WHERE user_id=3 AND parameter_name='min_pf_to_filter'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
// $sql = "UPDATE trading_settings SET parameter_value=3 WHERE user_id=3 AND parameter_name='commission_per_lot'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
// $sql = "UPDATE trading_settings SET parameter_value=100000 WHERE user_id=3 AND parameter_name='volume_per_lot'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
// $sql = "UPDATE trading_settings SET parameter_value='true' WHERE user_id=3 AND parameter_name='system_to_use_1'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
// $sql = "UPDATE trading_settings SET parameter_value='true' WHERE user_id=3 AND parameter_name='system_to_use_2'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
// $sql = "UPDATE trading_settings SET parameter_value='true' WHERE user_id=3 AND parameter_name='system_to_use_3'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
// $sql = "UPDATE trading_settings SET parameter_value='true' WHERE user_id=3 AND parameter_name='system_to_use_4'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
// $sql = "UPDATE trading_settings SET parameter_value='true' WHERE user_id=3 AND parameter_name='system_to_use_5'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
// $sql = "UPDATE trading_settings SET parameter_value='true' WHERE user_id=3 AND parameter_name='system_to_use_6'";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }

// $sql = "DELETE FROM spread WHERE user_id=3";
// if ($stmt = $db_connect->prepare($sql)) {
//     $stmt->execute();
// }
...
// $sql = "INSERT INTO spread (user_id,spread_date,spread_from,spread_to,spread_value) VALUES (3,?,0,0,0)";
// if ($stmt = $db_connect->prepare($sql)) {
